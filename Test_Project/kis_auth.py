...
# pip install PyYAML (패키지설치)
with open(os.path.join(config_root, "first_try.yaml"), encoding="UTF-8") as f:
...
def auth_ws(svr="vps", product=_cfg["my_prod"]):
...
def reAuth_ws(svr="vps", product=_cfg["my_prod"]):
    n2 = datetime.now()
